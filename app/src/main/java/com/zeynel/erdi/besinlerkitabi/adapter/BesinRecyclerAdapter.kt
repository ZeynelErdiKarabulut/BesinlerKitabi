package com.zeynel.erdi.besinlerkitabi.adapter
...
import com.zeynel.erdi.besinlerkitabi.databinding.BesinRecyclerRowBinding
import com.zeynel.erdi.besinlerkitabi.model.Besin
import com.zeynel.erdi.besinlerkitabi.view.BesinListesiFragmentDirections
...
class BesinRecyclerAdapter(val besinListesi : ArrayList<Besin>) : RecyclerView.Adapter<BesinRecyclerAdapter.BesinViewHolder>(),BesinClickListener {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BesinViewHolder {
        ...
        val view = DataBindingUtil.inflate<BesinRecyclerRowBinding>(inflater,
            R.layout.besin_recycler_row,parent,false)
